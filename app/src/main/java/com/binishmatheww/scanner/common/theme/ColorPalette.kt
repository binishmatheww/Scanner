...
object ColorPalette {
    ...
    val md_theme_light_primaryContainer = Color(0xFF8DFC66)
    ...
    val md_theme_dark_surfaceTint = Color(0xFF71DF4C)
    val md_theme_dark_outlineVariant = Color(0xFF43483F)
    val md_theme_dark_scrim = Color(0xFF000000)


    val seed = Color(0xFF2D9B00)
