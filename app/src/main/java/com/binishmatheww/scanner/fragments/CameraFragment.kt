...
import com.binishmatheww.scanner.fragments.dialogs.CameraSizeDialog
...
import com.binishmatheww.scanner.utils.calculateMegaPixels
import com.binishmatheww.scanner.utils.getOptimalPreviewSize
import com.binishmatheww.scanner.utils.temporaryLocation
    ...
    override fun onClick(view: View?) {
        ...
        when (view?.id) {
            ...
            R.id.switchCameraSize -> {
                 ...
                 dialog = CameraSizeDialog(supportedCameraSizes,object : OnDialogButtonClickListener{
